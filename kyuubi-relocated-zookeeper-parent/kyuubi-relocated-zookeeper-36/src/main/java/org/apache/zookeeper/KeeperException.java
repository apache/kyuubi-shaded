...
public abstract class KeeperException extends Exception {
  ...
  /**
   * This interface contains the original static final int constants which have now been replaced
   * with an enumeration in Code. Do not reference this class directly, if necessary (legacy code)
   * continue to access the constants through Code. Note: an interface is used here due to the fact
   * that enums cannot reference constants defined within the same enum as said constants are
   * considered initialized _after_ the enum itself. By using an interface as a super type this
   * allows the deprecated constants to be initialized first and referenced when constructing the
   * enums. I didn't want to have constants declared twice. This interface should be private, but
   * it's declared public to enable javadoc to include in the user API spec.
   */
  @Deprecated
  @InterfaceAudience.Public
  public interface CodeDeprecated {
    ...
    @Deprecated int SystemError = -1;
    /** @deprecated deprecated in 3.1.0, use {@link Code#RUNTIMEINCONSISTENCY} instead */
    @Deprecated int RuntimeInconsistency = -2;
    /** @deprecated deprecated in 3.1.0, use {@link Code#DATAINCONSISTENCY} instead */
    @Deprecated int DataInconsistency = -3;
    /** @deprecated deprecated in 3.1.0, use {@link Code#CONNECTIONLOSS} instead */
    @Deprecated int ConnectionLoss = -4;
    /** @deprecated deprecated in 3.1.0, use {@link Code#MARSHALLINGERROR} instead */
    @Deprecated int MarshallingError = -5;
    /** @deprecated deprecated in 3.1.0, use {@link Code#UNIMPLEMENTED} instead */
    @Deprecated int Unimplemented = -6;
    /** @deprecated deprecated in 3.1.0, use {@link Code#OPERATIONTIMEOUT} instead */
    @Deprecated int OperationTimeout = -7;
    /** @deprecated deprecated in 3.1.0, use {@link Code#BADARGUMENTS} instead */
    @Deprecated int BadArguments = -8;

    @Deprecated int UnknownSession = -12;

    /** @deprecated deprecated in 3.1.0, use {@link Code#NEWCONFIGNOQUORUM} instead */
    @Deprecated int NewConfigNoQuorum = -13;

    /** @deprecated deprecated in 3.1.0, use {@link Code#RECONFIGINPROGRESS} instead */
    @Deprecated int ReconfigInProgress = -14;

    /** @deprecated deprecated in 3.1.0, use {@link Code#APIERROR} instead */
    @Deprecated int APIError = -100;

    /** @deprecated deprecated in 3.1.0, use {@link Code#NONODE} instead */
    @Deprecated int NoNode = -101;
    /** @deprecated deprecated in 3.1.0, use {@link Code#NOAUTH} instead */
    @Deprecated int NoAuth = -102;
    /** @deprecated deprecated in 3.1.0, use {@link Code#BADVERSION} instead */
    @Deprecated int BadVersion = -103;
    /** @deprecated deprecated in 3.1.0, use {@link Code#NOCHILDRENFOREPHEMERALS} instead */
    @Deprecated int NoChildrenForEphemerals = -108;
    /** @deprecated deprecated in 3.1.0, use {@link Code#NODEEXISTS} instead */
    @Deprecated int NodeExists = -110;
    /** @deprecated deprecated in 3.1.0, use {@link Code#NOTEMPTY} instead */
    @Deprecated int NotEmpty = -111;
    /** @deprecated deprecated in 3.1.0, use {@link Code#SESSIONEXPIRED} instead */
    @Deprecated int SessionExpired = -112;
    /** @deprecated deprecated in 3.1.0, use {@link Code#INVALIDCALLBACK} instead */
    @Deprecated int InvalidCallback = -113;
    /** @deprecated deprecated in 3.1.0, use {@link Code#INVALIDACL} instead */
    @Deprecated int InvalidACL = -114;
    /** @deprecated deprecated in 3.1.0, use {@link Code#AUTHFAILED} instead */
    @Deprecated int AuthFailed = -115;

    // This value will be used directly in {@link CODE#SESSIONMOVED}
    // public static final int SessionMoved = -118;

    @Deprecated int EphemeralOnLocalSession = -120;
  }

  /**
   * Codes which represent the various KeeperException types. This enum replaces the deprecated
   * earlier static final int constants. The old, deprecated, values are in "camel case" while the
   * new enum values are in all CAPS.
   */
  @InterfaceAudience.Public
  public enum Code implements CodeDeprecated {
    ...
    /**
     * System and server-side errors. This is never thrown by the server, it shouldn't be used other
     * than to indicate a range. Specifically error codes greater than this value, but lesser than
     * {@link #APIERROR}, are system errors.
     */
    ...
    /**
     * API errors. This is never thrown by the server, it shouldn't be used other than to indicate a
     * range. Specifically error codes greater than this value are API errors (while values less
     * than this indicate a {@link #SYSTEMERROR}).
     */
    APIERROR(APIError),
    ...
    NOAUTH(NoAuth),
    /**
     * Version conflict In case of reconfiguration: reconfig requested from config version X but
     * last seen config has a different version Y
     */
     ...
     * authentication, but client is not configured with SASL authentication or configuted with SASL
     * but failed (i.e. wrong credential used.).
     */
