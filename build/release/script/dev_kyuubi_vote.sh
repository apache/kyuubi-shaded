...
# previous release version, e.g. v0.1.0, this is used to generate change log
...
cat >${DEV_VOTE}<<EOF
Title: [VOTE] Release Apache Kyuubi Shaded ${release_version} ${release_rc_no}
...
https://github.com/apache/kyuubi-shaded/compare/${prev_release_version}...${release_rc_tag}
