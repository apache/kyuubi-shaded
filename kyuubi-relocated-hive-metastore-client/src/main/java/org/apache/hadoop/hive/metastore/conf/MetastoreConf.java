...
public class MetastoreConf {
  ...
  @VisibleForTesting
  static final String HIVE_ALTER_HANDLE_CLASS = "org.apache.hadoop.hive.metastore.HiveAlterHandler";
  ...
  public enum ConfVars {
    // alpha order, PLEASE!
    ACID_HOUSEKEEPER_SERVICE_INTERVAL(
        "metastore.acid.housekeeper.interval",
        "hive.metastore.acid.housekeeper.interval",
        60,
        TimeUnit.SECONDS,
        "Time interval describing how often the acid housekeeper runs."),
    ACID_TXN_CLEANER_INTERVAL(
        "metastore.acid.txn.cleaner.interval",
        "hive.metastore.acid.txn.cleaner.interval",
        10,
        TimeUnit.SECONDS,
        "Time interval describing how often aborted and committed txns are cleaned."),
    ADDED_JARS(
        "metastore.added.jars.path", "hive.added.jars.path", "", "This an internal parameter."),
    AGGREGATE_STATS_CACHE_CLEAN_UNTIL(
        "metastore.aggregate.stats.cache.clean.until",
        "hive.metastore.aggregate.stats.cache.clean.until",
        0.8,
        "The cleaner thread cleans until cache reaches this % full size."),
    AGGREGATE_STATS_CACHE_ENABLED(
        "metastore.aggregate.stats.cache.enabled",
        "hive.metastore.aggregate.stats.cache.enabled",
        false,
        "Whether aggregate stats caching is enabled or not."),
    AGGREGATE_STATS_CACHE_FPP(
        "metastore.aggregate.stats.cache.fpp",
    ...
    AGGREGATE_STATS_CACHE_MAX_FULL(
        "metastore.aggregate.stats.cache.max.full",
        "hive.metastore.aggregate.stats.cache.max.full",
        0.9,
        "Maximum cache full % after which the cache cleaner thread kicks in."),
    AGGREGATE_STATS_CACHE_MAX_PARTITIONS(
        "metastore.aggregate.stats.cache.max.partitions",
        "hive.metastore.aggregate.stats.cache.max.partitions",
        10000,
        "Maximum number of partitions that are aggregated per cache node."),
    AGGREGATE_STATS_CACHE_MAX_READER_WAIT(
        "metastore.aggregate.stats.cache.max.reader.wait",
    ...
    AGGREGATE_STATS_CACHE_MAX_VARIANCE(
        "metastore.aggregate.stats.cache.max.variance",
    ...
    AGGREGATE_STATS_CACHE_MAX_WRITER_WAIT(
        "metastore.aggregate.stats.cache.max.writer.wait",
    ...
    AGGREGATE_STATS_CACHE_SIZE(
        "metastore.aggregate.stats.cache.size",
    ...
    AGGREGATE_STATS_CACHE_TTL(
        "metastore.aggregate.stats.cache.ttl",
    ...
    ALLOW_TENANT_BASED_STORAGE(
        "metastore.warehouse.tenant.colocation",
        "hive.metastore.warehouse.tenant.colocation",
        false,
    ...
    ASYNC_LOG_ENABLED(
        ...
        "Whether to enable Log4j2's asynchronous logging. Asynchronous logging can give\n"
            ...
            + " drawbacks."),
    AUTHORIZATION_STORAGE_AUTH_CHECKS(
        "metastore.authorization.storage.checks",
    ...
    BATCH_RETRIEVE_OBJECTS_MAX(
        "metastore.batch.retrieve.table.partition.max",
    ...
    CACHED_RAW_STORE_CACHED_OBJECTS_BLACKLIST(
        "metastore.cached.rawstore.cached.object.blacklist",
        "hive.metastore.cached.rawstore.cached.object.blacklist",
        "",
        "Comma separated list of regular expressions \n "
    ...
    CACHED_RAW_STORE_MAX_CACHE_MEMORY(
        ...
        "hive.metastore.cached.rawstore.max.cache.memory",
        "1Gb",
        new SizeValidator(),
    ...
    CAPABILITY_CHECK(
        "metastore.client.capability.check",
    ...
    CATALOGS_TO_CACHE(
        ...
        "metastore.cached.rawstore.catalogs",
        "hive",
        "Comma separated list of catalogs to cache in the CachedStore. Default is 'hive' "
    ...
    COMPACTOR_HISTORY_RETENTION_DID_NOT_INITIATE(
        "metastore.compactor.history.retention.did.not.initiate",
        "hive.compactor.history.retention.did.not.initiate",
        2,
        new RangeValidator(0, 100),
        "Determines how many compaction records in state "
    ...
    COMPACTOR_HISTORY_RETENTION_FAILED(
        "metastore.compactor.history.retention.failed",
    ...
    COMPACTOR_HISTORY_RETENTION_SUCCEEDED(
        "metastore.compactor.history.retention.succeeded",
        "hive.compactor.history.retention.succeeded",
        3,
        new RangeValidator(0, 100),
        "Determines how many successful compaction records will be "
            + "retained in compaction history for a given table/partition."),
    COMPACTOR_HISTORY_RETENTION_REFUSED(
        "metastore.compactor.history.retention.refused",
        "hive.compactor.history.retention.refused",
        3,
        new RangeValidator(0, 100),
        "Determines how many refused compaction records will be "
            + "retained in compaction history for a given table/partition."),
    COMPACTOR_HISTORY_RETENTION_TIMEOUT(
        "metastore.compactor.history.retention.timeout",
        "hive.compactor.history.retention.timeout",
        7,
        TimeUnit.DAYS,
    ...
    COMPACTOR_INITIATOR_FAILED_RETRY_TIME(
        "metastore.compactor.initiator.failed.retry.time",
        "hive.compactor.initiator.failed.retry.time",
        7,
        TimeUnit.DAYS,
    ...
    COMPACTOR_RUN_AS_USER(
        "metastore.compactor.run.as.user",
        ...
        "Specify the user to run compactor Initiator and Worker as. If empty string, defaults to table/partition "
            + "directory owner."),
    COMPACTOR_USE_CUSTOM_POOL(
        "metastore.compactor.use.custom.pool",
        "hive.compactor.use.custom.pool",
        false,
        "internal usage only -- use custom connection pool specific to compactor components."),
    ...
    COMPACTOR_TABLES_WITH_ABORTEDTXN_THRESHOLD(
        ...
        "hive.compactor.tables.with.aborted.txn.threshold",
        1,
    ...
    COMPACTOR_FAILED_COMPACTION_RATIO_THRESHOLD(
        ...
        "hive.compactor.failed.compaction.ratio.threshold",
        .01,
    ...
    METASTORE_HOUSEKEEPING_LEADER_HOSTNAME(
    ...
    METASTORE_HOUSEKEEPING_LEADER_ELECTION(
        "metastore.housekeeping.leader.election",
        "metastore.housekeeping.leader.election",
        "host",
        new StringSetValidator("host", "lock"),
    ...
    METASTORE_HOUSEKEEPING_LEADER_AUDIT_FILE_LIMIT(
    ...
    METASTORE_HOUSEKEEPING_THREADS_ON(
        "metastore.housekeeping.threads.on",
        "hive.metastore.housekeeping.threads.on",
        false,
    ...
    METASTORE_ACIDMETRICS_THREAD_ON(
    ...
    METASTORE_ACIDMETRICS_TABLES_WITH_ABORTED_TXNS_THRESHOLD(
        "metastore.acidmetrics.table.aborted.txns.threshold",
        "hive.metastore.acidmetrics.table.aborted.txns.threshold",
        1500,
    ...
    METASTORE_DELTAMETRICS_MAX_CACHE_SIZE(
        "metastore.deltametrics.max.cache.size",
    ...
    METASTORE_DELTAMETRICS_DELTA_NUM_THRESHOLD(
        "metastore.deltametrics.delta.num.threshold",
    ...
    METASTORE_DELTAMETRICS_OBSOLETE_DELTA_NUM_THRESHOLD(
        "metastore.deltametrics.obsolete.delta.num.threshold",
    ...
    METASTORE_DELTAMETRICS_DELTA_PCT_THRESHOLD(
        "metastore.deltametrics.delta.pct.threshold",
    ...
    COMPACTOR_INITIATOR_ON(
        ...
        "Whether to run the initiator thread on this metastore instance or not.\n"
            ...
            + "on Hive transactions. For a complete list of parameters required for turning on\n"
            + "transactions, see hive.txn.manager."),
    COMPACTOR_CLEANER_ON(
        "metastore.compactor.cleaner.on",
    ...
    COMPACTOR_WORKER_DETECT_MULTIPLE_VERSION_THRESHOLD(
    ...
    HIVE_COMPACTOR_CLEANER_RETRY_RETENTION_TIME(
        "hive.compactor.cleaner.retry.retention.time",
        "hive.compactor.cleaner.retry.retentionTime",
        300,
        TimeUnit.SECONDS,
    ...
    COMPACTOR_CLEANER_TABLECACHE_ON(
        "metastore.compactor.cleaner.tablecache.on",
        "hive.compactor.cleaner.tablecache.on",
        true,
        "Enable table caching in the cleaner. Currently the cache is cleaned after each cycle."),
    COMPACTOR_CLEAN_ABORTS_USING_CLEANER(
        "metastore.compactor.clean.aborts.using.cleaner",
        "hive.compactor.clean.aborts.using.cleaner",
        true,
    ...
    HIVE_COMPACTOR_CONNECTION_POOLING_MAX_CONNECTIONS(
        "metastore.compactor.connectionPool.maxPoolSize",
        "hive.compactor.connectionPool.maxPoolSize",
        5,
    ...
    CONNECTION_POOLING_MAX_CONNECTIONS(
    ...
    CONNECT_URL_HOOK(
        "metastore.ds.connection.url.hook",
    ...
    CONNECTION_POOLING_TYPE(
        "datanucleus.connectionPoolingType",
        "datanucleus.connectionPoolingType",
        "HikariCP",
        new StringSetValidator("DBCP", "HikariCP", "NONE"),
    ...
    COUNT_OPEN_TXNS_INTERVAL(
        "metastore.count.open.txns.interval",
    ...
    DATANUCLEUS_AUTOSTART(
        ...
        "datanucleus.autoStartMechanismMode",
        "ignored",
        new StringSetValidator("ignored"),
    ...
    DATANUCLEUS_CACHE_LEVEL2_TYPE(
        "datanucleus.cache.level2.type", "datanucleus.cache.level2.type", "none", ""),
    DATANUCLEUS_INIT_COL_INFO(
        "datanucleus.rdbms.initializeColumnInfo",
        "datanucleus.rdbms.initializeColumnInfo",
        "NONE",
        "initializeColumnInfo setting for DataNucleus; set to NONE at least on Postgres."),
    DATANUCLEUS_PLUGIN_REGISTRY_BUNDLE_CHECK(
    ...
    DATANUCLEUS_TRANSACTION_ISOLATION(
        "datanucleus.transactionIsolation",
        "datanucleus.transactionIsolation",
        "read-committed",
        "Default transaction isolation level for identity generation."),
    DATANUCLEUS_USE_LEGACY_VALUE_STRATEGY(
        "datanucleus.rdbms.useLegacyNativeValueStrategy",
        "datanucleus.rdbms.useLegacyNativeValueStrategy",
        true,
        ""),
    DATANUCLEUS_QUERY_SQL_ALLOWALL(
    ...
    DBACCESS_SSL_TRUSTSTORE_PASSWORD(
        "metastore.dbaccess.ssl.truststore.password",
    ...
    DBACCESS_SSL_TRUSTSTORE_TYPE(
        "metastore.dbaccess.ssl.truststore.type",
        "hive.metastore.dbaccess.ssl.truststore.type",
        "jks",
    ...
    DELEGATION_TOKEN_RENEW_INTERVAL(
        "metastore.cluster.delegation.token.renew-interval",
        "hive.cluster.delegation.token.renew-interval",
        1,
        TimeUnit.DAYS,
        ""),
    DELEGATION_TOKEN_STORE_CLS(
        "metastore.cluster.delegation.token.store.class",
    ...
    DIRECT_SQL_MAX_ELEMENTS_IN_CLAUSE(
    ...
    DIRECT_SQL_MAX_ELEMENTS_VALUES_CLAUSE(
        "metastore.direct.sql.max.elements.values.clause",
        "hive.direct.sql.max.elements.values.clause",
        1000,
        "The maximum number of values in a VALUES clause for INSERT statement."),
    DIRECT_SQL_MAX_PARAMETERS(
        "metastore.direct.sql.max.parameters",
        "hive.direct.sql.max.parameters",
        1000,
        "The maximum query parameters \n" + "backend sql engine can support."),
    DIRECT_SQL_MAX_QUERY_LENGTH(
        "metastore.direct.sql.max.query.length",
        "hive.direct.sql.max.query.length",
        100,
        "The maximum\n" + " size of a query string (in KB)."),
    DIRECT_SQL_PARTITION_BATCH_SIZE(
        "metastore.direct.sql.batch.size",
    ...
    ALLOW_INCOMPATIBLE_COL_TYPE_CHANGES_TABLE_SERDES(
        "metastore.allow.incompatible.col.type.changes.serdes",
    ...
    END_FUNCTION_LISTENERS(
        "metastore.end.function.listeners",
        "hive.metastore.end.function.listeners",
        "",
        "List of comma separated listeners for the end of metastore functions."),
    EVENT_CLEAN_FREQ(
        "metastore.event.clean.freq",
    ...
    EVENT_EXPIRY_DURATION(
        "metastore.event.expiry.duration",
    ...
    EVENT_MESSAGE_FACTORY(
        "metastore.event.message.factory",
        "hive.metastore.event.message.factory",
        "org.apache.hadoop.hive.metastore.messaging.json.gzip.GzipJSONMessageEncoder",
        "Factory class for making encoding and decoding messages in the events generated."),
    REPL_MESSAGE_FACTORY(
        "metastore.repl.message.factory",
    ...
    EVENT_NOTIFICATION_PARAMETERS_EXCLUDE_PATTERNS(
        "metastore.notification.parameters.exclude.patterns",
    ...
    EVENT_DB_LISTENER_TTL(
        "metastore.event.db.listener.timetolive",
    ...
    EVENT_CLEAN_MAX_EVENTS(
        "metastore.event.db.clean.maxevents",
        ...
        "Limit on number events to be cleaned at a time in metastore cleanNotificationEvents "
            ...
            + "a negative value."),
    EVENT_DB_LISTENER_CLEAN_INTERVAL(
    ...
    DECODE_FILTER_EXPRESSION_TO_STRING(
        "metastore.decode.filter.expression.tostring",
        "hive.metastore.decode.filter.expression.tostring",
        false,
    ...
    HMS_HANDLER_ATTEMPTS(
        "metastore.hmshandler.retry.attempts",
        "hive.hmshandler.retry.attempts",
        10,
        "The number of times to retry a HMSHandler call if there were a connection error."),
    HMS_HANDLER_FORCE_RELOAD_CONF(
        "metastore.hmshandler.force.reload.conf",
    ...
    // Note: This value is not passed into the JDBC driver, therefore this batch size limit is not
    // automatically enforced.
    // Batch construction/splits should be done manually in code using this config value.
    JDBC_MAX_BATCH_SIZE(
        "metastore.jdbc.max.batch.size",
    ...
    THRIFT_METASTORE_AUTHENTICATION(
    ...
    THRIFT_METASTORE_AUTHENTICATION_JWT_JWKS_URL(
        "metastore.authentication.jwt.jwks.url",
        "hive.metastore.authentication.jwt.jwks.url",
        "",
        "File URL from where URLBasedJWKSProvider "
    ...
    METASTORE_CUSTOM_AUTHENTICATION_CLASS(
    ...
    METASTORE_PLAIN_LDAP_BASEDN(
        "metastore.authentication.ldap.baseDN",
        "hive.metastore.authentication.ldap.baseDN",
        "",
        "LDAP base DN"),
    METASTORE_PLAIN_LDAP_DOMAIN(
        "metastore.authentication.ldap.Domain",
        "hive.metastore.authentication.ldap.Domain",
        "",
        ""),
    METASTORE_PLAIN_LDAP_GROUPDNPATTERN(
        "metastore.authentication.ldap.groupDNPattern",
    ...
    METASTORE_PLAIN_LDAP_GROUPFILTER(
        "metastore.authentication.ldap.groupFilter",
    ...
    METASTORE_PLAIN_LDAP_USERDNPATTERN(
    ...
    METASTORE_PLAIN_LDAP_USERFILTER(
        "metastore.authentication.ldap.userFilter",
    ...
    METASTORE_PLAIN_LDAP_GUIDKEY(
        "metastore.authentication.ldap.guidKey",
        "hive.metastore.authentication.ldap.guidKey",
        "uid",
        "LDAP attribute name whose values are unique in this LDAP server.\n"
            + "For example: uid or CN."),
    METASTORE_PLAIN_LDAP_GROUPMEMBERSHIP_KEY(
    ...
    METASTORE_PLAIN_LDAP_USERMEMBERSHIP_KEY(
    ...
    METASTORE_PLAIN_LDAP_GROUPCLASS_KEY(
        "metastore.authentication.ldap.groupClassKey",
    ...
    METASTORE_PLAIN_LDAP_CUSTOMLDAPQUERY(
        "metastore.authentication.ldap.customLDAPQuery",
    ...
    METASTORE_PLAIN_LDAP_USERSEARCHFILTER(
        "metastore.authentication.ldap.userSearchFilter",
    ...
    METASTORE_PLAIN_LDAP_GROUPBASEDN(
        "metastore.authentication.ldap.groupBaseDN",
    ...
    METASTORE_PLAIN_LDAP_GROUPSEARCHFILTER(
        "metastore.authentication.ldap.groupSearchFilter",
    ...
    METASTORE_PLAIN_LDAP_BIND_USER(
        "metastore.authentication.ldap.binddn",
    ...
    METASTORE_PLAIN_LDAP_BIND_PASSWORD(
        "metastore.authentication.ldap.bindpw",
    ...
    MANAGER_FACTORY_CLASS(
        "javax.jdo.PersistenceManagerFactoryClass",
        "javax.jdo.PersistenceManagerFactoryClass",
        "org.datanucleus.api.jdo.JDOPersistenceManagerFactory",
        "class implementing the jdo persistence"),
    MATERIALIZATIONS_INVALIDATION_CACHE_IMPL(
        "metastore.materializations.invalidation.impl",
        "hive.metastore.materializations.invalidation.impl",
        "DEFAULT",
    ...
    MATERIALIZATIONS_INVALIDATION_CACHE_CLEAN_FREQUENCY(
        "metastore.materializations.invalidation.clean.frequency",
        "hive.metastore.materializations.invalidation.clean.frequency",
        3600,
        TimeUnit.SECONDS,
        "Frequency at which timer task runs to remove unnecessary transaction entries from"
            + "materializations invalidation cache."),
    MATERIALIZATIONS_INVALIDATION_CACHE_EXPIRY_DURATION(
        "metastore.materializations.invalidation.max.duration",
        "hive.metastore.materializations.invalidation.max.duration",
        86400,
        TimeUnit.SECONDS,
        "Maximum duration for query producing a materialization. After this time, transaction"
            + "entries that are not relevant for materializations can be removed from invalidation cache."),

    RUNTIME_STATS_CLEAN_FREQUENCY(
        "metastore.runtime.stats.clean.frequency",
        "hive.metastore.runtime.stats.clean.frequency",
        3600,
        TimeUnit.SECONDS,
        "Frequency at which timer task runs to remove outdated runtime stat entries."),
    RUNTIME_STATS_MAX_AGE(
        "metastore.runtime.stats.max.age",
        "hive.metastore.runtime.stats.max.age",
        86400 * 3,
        TimeUnit.SECONDS,
        "Stat entries which are older than this are removed."),

    SCHEDULED_QUERIES_ENABLED(
        "metastore.scheduled.queries.enabled",
        "hive.metastore.scheduled.queries.enabled",
        true,
        "Wheter scheduled query metastore requests be processed"),
    SCHEDULED_QUERIES_EXECUTION_PROGRESS_TIMEOUT(
        "metastore.scheduled.queries.execution.timeout",
        "hive.metastore.scheduled.queries.progress.timeout",
        120,
        TimeUnit.SECONDS,
        "If a scheduled query is not making progress for this amount of time it will be considered TIMED_OUT"),
    SCHEDULED_QUERIES_EXECUTION_MAINT_TASK_FREQUENCY(
        "metastore.scheduled.queries.execution.maint.task.frequency",
        "hive.metastore.scheduled.queries.execution.clean.frequency",
        60,
        TimeUnit.SECONDS,
    ...
    SCHEDULED_QUERIES_EXECUTION_MAX_AGE(
        "metastore.scheduled.queries.execution.max.age",
        "hive.metastore.scheduled.queries.execution.max.age",
        30 * 86400,
        TimeUnit.SECONDS,
        "Maximal age of a scheduled query execution entry before it is removed."),

    SCHEDULED_QUERIES_AUTODISABLE_COUNT(
        "metastore.scheduled.queries.autodisable.count",
        "metastore.scheduled.queries.autodisable.count",
        0,
    ...
    METADATA_EXPORT_LOCATION(
        "metastore.metadata.export.location",
        "hive.metadata.export.location",
        "",
        "When used in conjunction with the org.apache.hadoop.hive.ql.parse.MetaDataExportListener pre event listener, \n"
            + "it is the location to which the metadata will be exported. The default is an empty string, which results in the \n"
            + "metadata being exported to the current user's home directory on HDFS."),
    METASTORE_MAX_EVENT_RESPONSE(
        "metastore.max.event.response",
        "hive.metastore.max.event.response",
        1000000,
        "The parameter will decide the maximum number of events that HMS will respond."),
    METASTORE_CLIENT_FILTER_ENABLED(
        "metastore.client.filter.enabled",
        "hive.metastore.client.filter.enabled",
        true,
    ...
    MOVE_EXPORTED_METADATA_TO_TRASH(
        "metastore.metadata.move.exported.metadata.to.trash",
    ...
    METRICS_HADOOP2_COMPONENT_NAME(
        "metastore.metrics.hadoop2.component",
        "hive.service.metrics.hadoop2.component",
        "hivemetastore",
        "Component name to provide to Hadoop2 Metrics system."),
    METRICS_HADOOP2_INTERVAL(
        "metastore.metrics.hadoop2.component",
    ...
    METRICS_JSON_FILE_INTERVAL(
        "metastore.metrics.file.frequency",
    ...
    METRICS_JSON_FILE_LOCATION(
        "metastore.metrics.file.location",
    ...
    METRICS_SLF4J_LOG_FREQUENCY_MINS(
        "metastore.metrics.slf4j.frequency",
        "hive.service.metrics.slf4j.frequency",
        5,
        TimeUnit.MINUTES,
        "For SLF4J metric reporter, the frequency of logging metrics events. The default value is 5 mins."),
    METRICS_SLF4J_LOG_LEVEL(
        "metastore.metrics.slf4j.logging.level",
        "hive.service.metrics.slf4j.logging.level",
        "INFO",
    ...
    MSCK_REPAIR_BATCH_SIZE(
        "metastore.msck.repair.batch.size",
    ...
    MSCK_REPAIR_BATCH_MAX_RETRIES(
        "metastore.msck.repair.batch.max.retries",
    ...
    MSCK_REPAIR_ENABLE_PARTITION_RETENTION(
        "metastore.msck.repair.enable.partition.retention",
        "metastore.msck.repair.enable.partition.retention",
        false,
    ...
    GETPARTITIONS_BATCH_MAX_RETRIES(
        "metastore.getpartitions.batch.max.retries",
        "hive.getpartitions.batch.max.retries",
        5,
    ...
    PARTITION_MANAGEMENT_TASK_FREQUENCY(
        "metastore.partition.management.task.frequency",
        "metastore.partition.management.task.frequency",
        6,
        TimeUnit.HOURS,
        "Frequency at which timer task runs to do automatic partition management for tables\n"
    ...
    PARTITION_MANAGEMENT_TABLE_TYPES(
    ...
    PARTITION_MANAGEMENT_TASK_THREAD_POOL_SIZE(
        "metastore.partition.management.task.thread.pool.size",
        "metastore.partition.management.task.thread.pool.size",
        3,
    ...
    PARTITION_MANAGEMENT_CATALOG_NAME(
        "metastore.partition.management.catalog.name",
        "metastore.partition.management.catalog.name",
        "hive",
        "Automatic partition management will look for tables under the specified catalog name"),
    PARTITION_MANAGEMENT_DATABASE_PATTERN(
    ...
    PARTITION_MANAGEMENT_TABLE_PATTERN(
    ...
    METASTORE_METADATA_TRANSFORMER_LOCATION_MODE(
        "metastore.metadata.transformer.location.mode",
        "metastore.metadata.transformer.location.mode",
        "force",
    ...
    NOTIFICATION_SEQUENCE_LOCK_MAX_RETRIES(
        "metastore.notification.sequence.lock.max.retries",
    ...
    ORM_RETRIEVE_MAPNULLS_AS_EMPTY_STRINGS(
        "metastore.orm.retrieveMapNullsAsEmptyStrings",
    ...
    PARTITION_NAME_WHITELIST_PATTERN(
    ...
    REPLCMRETIAN(
        "metastore.repl.cm.retain",
        "hive.repl.cm.retain",
        24 * 10,
        TimeUnit.HOURS,
        "Time to retain removed files in cmrootdir."),
    REPLCMINTERVAL(
        "metastore.repl.cm.interval",
        "hive.repl.cm.interval",
        3600,
        TimeUnit.SECONDS,
        "Inteval for cmroot cleanup thread."),
    REPLCMENABLED(
        "metastore.repl.cm.enabled",
        "hive.repl.cm.enabled",
        false,
        "Turn on ChangeManager, so delete files will go to cmrootdir."),
    REPLDIR(
        "metastore.repl.rootdir",
        "hive.repl.rootdir",
        "/user/${system:user.name}/repl/",
        "HDFS root dir for all replication dumps."),
    REPL_COPYFILE_MAXNUMFILES(
        "metastore.repl.copyfile.maxnumfiles",
    ...
    REPL_COPYFILE_MAXSIZE(
        "metastore.repl.copyfile.maxsize",
    ...
    REPL_EVENT_DB_LISTENER_TTL(
        "metastore.repl.event.db.listener.timetolive",
    ...
    REPL_METRICS_CACHE_MAXSIZE(
        "metastore.repl.metrics.cache.maxsize",
        "hive.repl.metrics.cache.maxsize",
        10000 /*10000 rows */,
    ...
    REPL_METRICS_UPDATE_FREQUENCY(
        "metastore.repl.metrics.update.frequency",
        "hive.repl.metrics.update.frequency",
        1L,
        TimeUnit.MINUTES /*1 minute */,
        "Frequency at which replication Metrics will be stored in persistent storage. "),
    REPL_METRICS_CLEANUP_FREQUENCY(
        "metastore.repl.metrics.cleanup.frequency",
        "hive.metastore.repl.metrics.cleanup.frequency",
        1,
        TimeUnit.DAYS,
    ...
    REPL_METRICS_MAX_AGE(
        "metastore.repl.metrics.max.age",
        "hive.metastore.repl.metrics.max.age",
        7,
        TimeUnit.DAYS,
        "Maximal age of a replication metrics entry before it is removed."),
    REPL_TXN_TIMEOUT(
        "metastore.repl.txn.timeout",
        "hive.repl.txn.timeout",
        11,
        TimeUnit.DAYS,
    ...
    SCHEMA_VERIFICATION_RECORD_VERSION(
        "metastore.schema.verification.record.version",
        "hive.metastore.schema.verification.record.version",
        false,
        "When true the current MS version is recorded in the VERSION table. If this is disabled and verification is\n"
            + " enabled the MS will be unusable."),
    SERDES_USING_METASTORE_FOR_SCHEMA(
        "metastore.serdes.using.metastore.for.schema",
    ...
    SERDES_WITHOUT_FROM_DESERIALIZER(
        "metastore.serdes.without.from.deserializer",
    ...
    SERVER_MAX_MESSAGE_SIZE(
        "metastore.server.max.message.size",
        "hive.metastore.server.max.message.size",
        100 * 1024 * 1024L,
        "Maximum message size in bytes a HMS will accept."),
    SERVER_MAX_THREADS(
        "metastore.server.max.threads",
        "hive.metastore.server.max.threads",
        1000,
        "Maximum number of worker threads in the Thrift server's pool."),
    SERVER_MIN_THREADS(
        "metastore.server.min.threads",
        "hive.metastore.server.min.threads",
        200,
        "Minimum number of worker threads in the Thrift server's pool."),
    SERVER_PORT(
        "metastore.thrift.port", "hive.metastore.port", 9083, "Hive metastore listener port"),
    ...
    STATS_FETCH_KLL(
        "metastore.stats.fetch.kll",
        "hive.stats.fetch.kll",
        false,
        "Whether we fetch KLL data sketches to enable histogram statistics"),
    STATS_NDV_TUNER(
        "metastore.stats.ndv.tuner",
    ...
    STATS_NDV_DENSITY_FUNCTION(
        "metastore.stats.ndv.densityfunction",
    ...
    STATS_DEFAULT_AGGREGATOR(
        "metastore.stats.default.aggregator",
        "hive.stats.default.aggregator",
        "",
        "The Java class (implementing the StatsAggregator interface) that is used by default if hive.stats.dbclass is custom type."),
    STATS_DEFAULT_PUBLISHER(
        "metastore.stats.default.publisher",
        "hive.stats.default.publisher",
        "",
        "The Java class (implementing the StatsPublisher interface) that is used by default if hive.stats.dbclass is custom type."),
    STATS_AUTO_UPDATE(
        "metastore.stats.auto.analyze",
        "hive.metastore.stats.auto.analyze",
        "none",
    ...
    STATS_AUTO_UPDATE_NOOP_WAIT(
        "metastore.stats.auto.analyze.noop.wait",
        "hive.metastore.stats.auto.analyze.noop.wait",
        5L,
        TimeUnit.MINUTES,
    ...
    STATS_AUTO_UPDATE_WORKER_COUNT(
        "metastore.stats.auto.analyze.worker.count",
        "hive.metastore.stats.auto.analyze.worker.count",
        1,
        "Number of parallel analyze commands to run for background stats update."),
    STORAGE_SCHEMA_READER_IMPL(
    ...
    STORE_MANAGER_TYPE(
        ...
        "rdbms",
        "metadata store type"),
    STRICT_MANAGED_TABLES(
        "metastore.strict.managed.tables",
    ...
    SUPPORT_SPECICAL_CHARACTERS_IN_TABLE_NAMES(
        "metastore.support.special.characters.tablename",
    ...
    TASK_THREADS_ALWAYS(
        ...
        "metastore.task.threads.always",
        EVENT_CLEANER_TASK_CLASS
            + ","
            + RUNTIME_STATS_CLEANER_TASK_CLASS
            + ","
            + ACID_METRICS_TASK_CLASS
            + ","
            + ACID_METRICS_LOGGER_CLASS
            + ","
    ...
    THRIFT_ZOOKEEPER_USE_KERBEROS(
        "metastore.zookeeper.kerberos.enabled",
    ...
    METASTORE_CACHE_CAN_USE_EVENT(
        "metastore.cache.can.use.event",
        "hive.metastore.cache.can.use.event",
        false,
        "Can notification events from notification log table be used for updating the metastore cache."),
    TRANSACTIONAL_EVENT_LISTENERS(
    ...
    TXN_MAX_OPEN_BATCH(
        ...
        "Maximum number of transactions that can be fetched in one call to open_txns().\n"
            ...
            + "read performance."),
    TXN_RETRYABLE_SQLEX_REGEX(
        "metastore.txn.retryable.sqlex.regex",
    ...
    TXN_USE_MIN_HISTORY_WRITE_ID(
        "metastore.txn.use.minhistorywriteid",
        "hive.txn.use.minhistorywriteid",
        false,
    ...
    METASTORE_CLIENT_THRIFT_TRANSPORT_MODE(
        ...
        "Transport mode to be used by the metastore client. It should be the same as "
            + THRIFT_TRANSPORT_MODE),
    METASTORE_CLIENT_THRIFT_HTTP_PATH(
        "metastore.client.thrift.http.path",
        "hive.metastore.client.thrift.http.path",
        "metastore",
        "Path component of URL endpoint when in HTTP mode"),
    METASTORE_THRIFT_HTTP_REQUEST_HEADER_SIZE(
        "metastore.server.thrift.http.request.header.size",
        "hive.metastore.server.thrift.http.request.header.size",
        6 * 1024,
        "Request header size in bytes when using HTTP transport mode for metastore thrift server."
            + " Defaults to jetty's defaults"),
    METASTORE_THRIFT_HTTP_RESPONSE_HEADER_SIZE(
        "metastore.server.thrift.http.response.header.size",
        "metastore.server.thrift.http.response.header.size",
        6 * 1024,
        "Response header size in bytes when using HTTP transport mode for metastore thrift server."
            + " Defaults to jetty's defaults"),
    METASTORE_THRIFT_HTTP_MAX_IDLE_TIME(
        "metastore.thrift.http.max.idle.time",
        "hive.metastore.thrift.http.max.idle.time",
        1800,
        TimeUnit.SECONDS,
    ...
    METASTORE_CLIENT_PLAIN_USERNAME(
        ...
        "The username used by the metastore client when "
            ...
            + "alias."),
    THRIFT_AUTH_CONFIG_USERNAME(
        "metastore.authentication.config.username",
        "hive.metastore.authentication.config.username",
        "",
        "If "
            + THRIFT_METASTORE_AUTHENTICATION
            + " is set to CONFIG, username provided by "
            + "client is matched against this value."),
    THRIFT_AUTH_CONFIG_PASSWORD(
        "metastore.authentication.config.password",
        "hive.metastore.authentication.config.password",
        "",
        "If "
            + THRIFT_METASTORE_AUTHENTICATION
            + " is set to CONFIG, password provided by "
    ...
    WM_DEFAULT_POOL_SIZE(
        "metastore.wm.default.pool.size",
    ...
    RAWSTORE_PARTITION_BATCH_SIZE(
        "metastore.rawstore.batch.size",
        "metastore.rawstore.batch.size",
        -1,
    ...
    HIVE_METASTORE_RUNWORKER_IN(
        ...
        "hive.metastore.runworker.in",
        "hs2",
        new StringSetValidator("metastore", "hs2"),
    ...
    USE_CUSTOM_RDBMS(
        ...
        "hive.metastore.use.custom.database.product",
        false,
    ...
    CUSTOM_RDBMS_CLASSNAME(
        "metastore.custom.database.product.classname",
        "hive.metastore.custom.database.product.classname",
        "none",
    ...
    // Property-maps
    PROPERTIES_CACHE_CAPACITY(
        "hive.metastore.properties.cache.capacity",
        "hive.metastore.properties.cache.maxsize",
        64,
        "Maximum number of property-maps (collection of properties for one entity) held in cache per store."),
    PROPERTIES_CACHE_LOADFACTOR(
        "hive.metastore.properties.cache.loadfactor",
        "hive.metastore.properties.cache.maxsize",
        0.75d,
        "Property-maps cache map initial fill factor (> 0.0, < 1.0)."),
    PROPERTIES_SERVLET_PATH(
        "hive.metastore.properties.servlet.path",
        "hive.metastore.properties.servlet.path",
        "hmscli",
        "Property-maps servlet path component of URL endpoint."),
    PROPERTIES_SERVLET_PORT(
        "hive.metastore.properties.servlet.port",
        "hive.metastore.properties.servlet.port",
        -1,
    ...
    PROPERTIES_SERVLET_AUTH(
        "hive.metastore.properties.servlet.auth",
        "hive.metastore.properties.servlet.auth",
        "jwt",
    ...
    @Deprecated
    HIVE_CODAHALE_METRICS_REPORTER_CLASSES(
    ...
    @Deprecated
    DBACCESS_SSL_PROPS(
        "metastore.dbaccess.ssl.properties",
    ...
    METASTORE_NUM_STRIPED_TABLE_LOCKS(
        "metastore.num.striped.table.locks",
        "hive.metastore.num.striped.table.locks",
        32,
    ...
    COLSTATS_RETAIN_ON_COLUMN_REMOVAL(
        "metastore.colstats.retain.on.column.removal",
        "hive.metastore.colstats.retain.on.column.removal",
        true,
    ...
    STR_SET_ENTRY(
        "test.str.set", "hive.test.str.set", "a", new StringSetValidator("a", "b", "c"), ""),
    ...
    DEPRECATED_TEST_ENTRY(
        "test.deprecated",
        "hive.test.deprecated",
        0,
        new RangeValidator(0, 3),
        "comment",
        "this.is.the.metastore.deprecated.name",
        "this.is.the.hive.deprecated.name"),
    TIME_VALIDATOR_ENTRY_INCLUSIVE(
        "test.time.validator.inclusive",
        "hive.test.time.validator.inclusive",
        1,
        TimeUnit.SECONDS,
        new TimeValidator(TimeUnit.MILLISECONDS, 500L, true, 1500L, true),
        "comment"),
    TIME_VALIDATOR_ENTRY_EXCLUSIVE(
        "test.time.validator.exclusive",
        "hive.test.time.validator.exclusive",
        1,
        TimeUnit.SECONDS,
        new TimeValidator(TimeUnit.MILLISECONDS, 500L, false, 1500L, false),
        "comment"),
