...
import org.apache.kyuubi.hive.metastore.security.DelegationTokenIdentifier;
import org.apache.kyuubi.hive.metastore.security.DelegationTokenSelector;
...
public class SecurityUtils {
  ...
  public static void setZookeeperClientKerberosJaasConfig(String principal, String keyTabFile)
    ...
    JaasConfiguration jaasConf =
        new JaasConfiguration(SASL_LOGIN_CONTEXT_NAME, principal, keyTabFile);
